...
def index(request):
    return render(request, 'pravniservice/index.html')
...
def add_student(request):
    try:
        ...
        return render(request, 'pravniservice/add-student.html', {
            'form': student_form
        })
    ...
    try:
        if request.method == 'GET':
            ...
            if professor_form.is_valid():
                ...
                response = requests.post("http://nginx:80/professors", headers={
                    'Content-Type': 'application/json',
                    'Accept-Encoding': 'gzip.deflate.br',
                    'Connection': 'keep-alive'
                }, data=body)
        ...
        return render(request, 'pravniservice/add-professor.html', {
            'form': professor_form
        })
    except Exception as e:
        return render(request, 'pravniservice/add-professor.html')
